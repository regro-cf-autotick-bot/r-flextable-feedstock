...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-flextable-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-flextable-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-flextable
# for installing globally
pixi global install r-flextable
```
...
It is possible to list all of the versions of `r-flextable` available on your platform:
...
```
pixi search r-flextable --channel conda-forge
```
